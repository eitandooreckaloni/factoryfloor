...
- **Scouted**: Ideas generated by the Scout agent
- **Ranked**: Ideas scored >= 5.0 by the Ranker agent, ready for spec
- **Specced**: Ideas with complete specifications
- **Designed**: Ideas with UI/UX design complete
- **Scaffolded**: Ideas with repo scaffolded by the Builder agent
